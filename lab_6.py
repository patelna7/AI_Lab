...
class GameLoop:
    ...
    def DrawX(self, x, y):
        x += 1
        y += 1
        line_thickness = 30  # Set the desired line thickness for the X symbol
        x1 = 200 * x - 200 + 40
        y1 = 200 * y - 200 + 40
        x2 = x * 200 - 40
        y2 = y * 200 - 40
        pygame.draw.line(self.screen, (100, 100, 100), (x1, y1), (x2, y2), line_thickness)
        pygame.draw.line(self.screen, (100, 100, 100), (x1, y2), (x2, y1), line_thickness)
        pygame.draw.line(self.screen, (255, 255, 255), (x1 - 2, y1 - 2), (x2 - 2, y2 - 2), line_thickness - 4)
        pygame.draw.line(self.screen, (255, 255, 255), (x1 - 2, y2 - 2), (x2 - 2, y1 - 2), line_thickness - 4)

    def DrawO(self, x, y):
        x += 1
        y += 1
        line_thickness = 30  # Set the desired line thickness for the outline of the 'O' symbol
    ...
    def GameOver(self):
        ...
        if self.GameState == 1:
            self.ShowMessage('Перемога за машиною')
        elif self.GameState == 0:
            self.ShowMessage('Нічия')
        elif self.GameState == -1:
            self.ShowMessage('Перемога за гравцем')
